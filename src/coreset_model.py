...
def get_coreset_model(
    ...
    **kwargs,
    ...
    if model_config.coreset_model_name == "constcore":
...
class AblationTailedPatch(BaseCore):
    ...
    def __init__(
        ...
        super(AblationTailedPatch, self).__init__()
    ...
    def _get_features(
        ...
        with tqdm(
            ...
            for data in data_iterator:
                ...
                with torch.no_grad():
                    _features = self.feature_embedder(images)
                    _embeddings = self.embedding_extractor(images.to(self.device)).cpu()
